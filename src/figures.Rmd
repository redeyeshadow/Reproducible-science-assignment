...
###saving the figure and defing size, scale and resolution
```{r}

# Save the plot for a report
save_penguin_graph_png(graph_data, "figures/penguin_report.png", 
                      size = 15, res = 600, scaling = 1)

# Save the plot for a presentation
save_penguin_graph_png(graph_data, "figures/penguin_powerpoint.png", 
                      size = 15, res = 600, scaling = 1.2)

# Save the plot for a poster
save_penguin_graph_png(graph_data, "figures/penguin_poster.png", 
                      size = 30, res = 600, scaling = 2.4)

# Save the plot as a vector (no resolution needed)
save_penguin_graph_svg(graph_data, "figures/penguins_vector.svg", 
                      size = 15, scaling = 1)
```
